...
import { FiShoppingCart, FiUser, FiBell, FiTrello } from "react-icons/fi";
            ...
            <div className="hidden md:hidden md:items-center lg:flex xl:block absolute inset-y-0 right-0 pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              >
                ...
                {shopInfo?.attributes.logo ? (
                  <Link href="/user/list-shops">
                    <a className="relative top-1 w-6 h-6">
                      <Image
                        width={29}
                        height={29}
                        src={shopInfo?.attributes.logo}
                        alt="shop"
              ...
              <button
                className="pl-10 text-white text-2xl font-bold"
                aria-label="Login"
              >
