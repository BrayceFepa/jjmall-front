...
const RegisterPage3 = ({ setShowResetPassword, setModalOpen,setShowRegisterPage3,setShowRegisterPage4 }) => {
    ...
    for (let index = 1; index < 4; index++) {
      ...
      const userData = {
        "data":{
          ...
          security_question:data['security_question'+index] ? 2: '',
          user:userInfo ? userInfo?.user?.id : null
        }
      };
      setLoading(true);
      UserServices.addAnswer(userData)
        .then((res) => {
