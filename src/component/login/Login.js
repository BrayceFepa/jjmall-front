        ...
        <div className="grid grid-cols-1 gap-5">
          <div className="form-group">
            ...
            <div class="flex w-full">
              <button class="text-sm w-full px-2 font-medium leading-5 h-10 bg-white text-thirdly
                border-2 py-1 shadow-sm 
                duration-150 ease-in-out"
                style={{borderColor:isactiveButton1? valborderColor : transparent,borderWidth:2}}
                onClick={()=>{setIsactiveButton1(true);setIsactiveButton2(false)}}
                type="button"
              >
                E-mail
              </button>
              <button class="text-sm w-full px-2 font-medium leading-5 h-10 bg-white text-thirdly
                ...
                onClick={()=>{setIsactiveButton2(true);setIsactiveButton1(false)}}
                type="button" 
              >
                  Phone Number
              </button>
