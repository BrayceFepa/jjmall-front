...
const GenericProducts = () => {
  ...
  return (
    <>
      {showUpdateGenericProduct && (
        <UpdateGenericProductModal
          modalOpen={showUpdateGenericProduct}
          setModalOpen={setShowUpdateGenericProduct}
          data={genericProductbyId}
          setData={setData}
        />
      )}
      {showDeleteGenericProduct && (
        <DeleteGenericProductModal
          modalOpen={showDeleteGenericProduct}
          setModalOpen={setShowDeleteGenericProduct}
          data={genericProductbyId}
          setData={setData}
        />
      )}
      {isLoading ? (
        ...
        <Dashboard
          title="List Generic Products"
          description="This is user generic products page"
        >
            ...
            {loading ? (
              ...
              <div className="text-center">
                ...
                <h2 className="font-medium text-md my-4 text-gray-600">
                  There is no generic product yet!
                </h2>
              </div>
            ) : (
              <div className="flex flex-col">
                <h2 className="text-xl font-serif font-semibold mb-5">
                  List of Generic Products
                </h2>
                            ...
                            <tr key={generic_Product.id}>
                              ...
                              <td className="px-5 py-3 leading-6 text-center whitespace-nowrap">
                                <span className="text-sm">
                                  {generic_Product.attributes?.name}
                                </span>
                              </td>

                              <td className="px-5 py-3 leading-6 text-center whitespace-nowrap">
                                <span className="text-sm">
                                  {generic_Product.attributes?.price}
                                </span>
                              </td>
                              <td className="px-5 py-3 leading-6 text-center whitespace-nowrap">
                                <button
